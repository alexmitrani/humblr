...
# examples of use ----------------------------------------------------------
  ...
  # mytest1 <- meta_model_prototype(myinputspreadsheet = "ridership_meta_model_prototype.xlsx")  
  # mytest2 <- meta_model_prototype(myinputspreadsheet = "revenue_meta_model_prototype.xlsx")  
